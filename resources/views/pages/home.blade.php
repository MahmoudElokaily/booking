                ...
                <div class="flex-fill">
                    <div class="modal-body body-svg">
                        ...
                        <div id="p-imgs">
                            ...
                            <input type="file" id="imgupload_post" style="display:none" accept="image/png, image/jpeg"
                                multiple="multiple">
                    ...
                    <article href="/qiongliwu/posts/27294">
                        <div class="d-inline-flex" style="width:100%"> <a href="#/qiongliwu">
                                <div class="info_author_photo pl-2 pt-2"><img
                                        ...
                                        alt="..." style="width:3rem;height:3rem" class="mr-3 rounded-circle"></div>
                            </a>
                                    ...
                                    <div class=" el-action-s menu-icon pl-2 pr-2 rounded-circle ml-auto">
                                        <div class="dropleft" data-toggle="tooltip" data-placement="top" title=""
                                            ...
                                            <span data-toggle="dropdown" aria-expanded="false">
                                                <svg viewBox="0 0 24 24" aria-hidden="true" class="blue" style="height:1.25rem;width:1.25rem; line-height: 1.65em;
                        cursor: pointer;">
                                                    <g>
                                ...
                                <div class="info-photo mr-3 border rounded p-1">
                                    <div class="info-img-box ">
                                        ...
                                        <div class="info-img-box-c">
                                            ...
                                            <div class="info-img-content post-image" datai="0" style="background-image: url('{{ asset('images/owner/' . $post['user']['name'] . '/' . $file) }}');"></div>
                                            {{-- @if ($index % 2 == 0)
                                        </div>
                                        @endif --}}
                                        @endforeach
                                ...
                                <div class="d-flex justify-content-between p-3 div-share-likes-reply">
                                    ...
                                    <div class="el-action-s  p-1 pl-2 pr-2 " data-toggle="tooltip" title=""
                                    ...
                                    <div class="el-action-s el-likes p-1 pl-2 pr-2" datau="27294">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                            data-toggle="tooltip" title="" class="rounded-circle p-1"
