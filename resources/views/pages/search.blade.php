...
@section('content')
    <div class="modal fade " id="postModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content" style="border-radius:2rem">
                ...
                <div class="d-flex">
                    <div class="m-2"> <img id="pro_user_header" src="./img/1637720930-1303e34387013ec393d2.png"
                        ...
                        <div class="modal-body body-svg">
                            ...
                            <div id="p-vtype" class="b-hang" dataid="vtype">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-fill text-right mr-3 del-hang"><svg xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 22 22">
                                            <path
                            ...
                            <div aria-activedescendant="typeaheadFocus-0.9675831414983171" aria-autocomplete="list"
                                id="post-text-b" aria-controls="typeaheadDropdownWrapped-47"
                                aria-describedby="placeholder-f43e6" aria-label="Tweet text" aria-multiline="true"
                            ...
                            <div id="p-imgs">
                                ...
                                <div id="img-action-html" style="display:none">
                                    <div aria-label="Remove media" role="button" tabindex="0" class="remove-img">
                                    ...
                                    <div aria-label="Edit media" role="button" tabindex="0" class="edit-img">
                            ...
                            <div id="p-replay" class="d-flext replay-g" data-toggle="dropdown" aria-expanded="false"
                                ...
                                <div class="d-inline-flex" style="width:100%"> <a href="#/qiongliwu">
                                    ...
                                    <div class="flex-fill pt-2">
                                        <div class="d-flex">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="d-flex">
                                                        <a href="#/qiongliwu" class="text-a">
                                                            <div style="line-height:100%"> <span class="v-text-s">
                                                                    {{ $post->user->name ?? '' }}</span>
                                                            </div>
                                                        </a>
                                            ...
                                            <div class=" el-action-s menu-icon pl-2 pr-2 rounded-circle ml-auto">
                                                <div class="dropleft" data-toggle="tooltip" data-placement="top"
                                                    ...
                                                    <span data-toggle="dropdown" aria-expanded="false">
                                                        <svg viewBox="0 0 24 24" aria-hidden="true" class="blue"
                                                            style="height:1.25rem;width:1.25rem; line-height: 1.65em;
                        cursor: pointer;">
                                                            <g>
    ...
    <div class="d-flex justify-content-between p-3 div-share-likes-reply">
        <div class="el-action-s el-reply p-1 pl-2 pr-2" data-toggle="tooltip" title="" datau=" 27294"
            data-original-title="Reply"><svg xmlns="http://www.w3.org/2000/svg" class="el-action-s"
                viewBox="0 0 24 24">
                <path
        ...
        <div class="el-action-s  p-1 pl-2 pr-2 " data-toggle="tooltip" title="" data-original-title="Relay">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-toggle="dropdown">
                <path d="M21 9h2v11h-17v3l-6-4 6-4v3h15v-9zm-18-3h15v3l6-4-6-4v3h-17v11h2v-9z">
                </path>
            </svg><span class="pl-1"></span>
            <div class="dropdown-menu p-3">
                <div class="d-flex div-info-more-item dropdown-item el-relay" datau="27294">
        ...
        <div class="el-action-s  p-1 pl-2 pr-2 " data-toggle="tooltip" title="" data-original-title="Chat">
            ...
            <div class="dropdown-menu p-3">
                <div class="d-flex div-info-more-item dropdown-item el-Chat" datau="27294">
        ...
        <div class="el-action-s  p-1 pl-2 pr-2" data-toggle="tooltip" title="" data-original-title="Share">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-toggle="dropdown">
                <path
            ...
            <div class="dropdown-menu p-3 shadow dropdown-menu-right ">
                <div class="d-flex div-info-more-item dropdown-item el-sendmsg" datau="27294">
                ...
                <div class="d-flex div-info-more-item dropdown-item el-bookmarks" datau="27294">
                    <div><svg viewBox="0 0 24 24" aria-hidden="true">
                            <g>
                                <path
        ...
        <div class="el-action-s el-likes p-1 pl-2 pr-2" datau="27294">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-toggle="tooltip" title=""
